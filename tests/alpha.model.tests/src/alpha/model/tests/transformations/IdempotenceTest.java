...
public class IdempotenceTest extends GenericAlphaSystemTest {

	private static final String ROOT_DIR = "resources/src-valid/transformation-tests/idempotence/";
	
	public IdempotenceTest(final IAlphaTestInput test) {
		super(test);
	}
	...
	protected void doTest(AlphaSystem system) {
		...
		forEach(x->{
			...
			Idempotence.apply((AbstractReduceExpression)x.getExpr());
