...
public class AlphaFormatter extends AbstractFormatter2 {
    ...
    if (keyword != null) {
      switch (keyword) {
        ...
        case "fuzzy":
          ...
          break;
        case "over":
          _switchResult = system.getSystemBodies().isEmpty();
          break;
        default:
          _switchResult = false;
          break;
  ...
  protected void _format(final AlphaSystem alphaSystem, @Extension final IFormattableDocument document) {
    ...
    EList<SystemBody> _systemBodies = alphaSystem.getSystemBodies();
    for (final SystemBody sysBody : _systemBodies) {
      {
        document.<SystemBody>format(sysBody);
        final Procedure1<IHiddenRegionFormatter> _function_1 = (IHiddenRegionFormatter it) -> {
          it.newLine();
        };
        document.<SystemBody>append(sysBody, _function_1);
      }
    }
  }
