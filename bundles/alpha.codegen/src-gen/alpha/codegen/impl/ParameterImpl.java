 ...
 * </p>
 * <ul>
 *   <li>{@link alpha.codegen.impl.ParameterImpl#getDataType <em>Data Type</em>}</li>
 *   <li>{@link alpha.codegen.impl.ParameterImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParameterImpl extends MinimalEObjectImpl.Container implements Parameter {
	...
	protected EClass eStaticClass() {
		return CodegenPackage.Literals.PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CodegenPackage.PARAMETER__NAME, oldName, name));
	}
