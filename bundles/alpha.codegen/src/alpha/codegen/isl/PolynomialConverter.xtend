...
class PolynomialConverter {
	 ...
	 */
	def static convert(ISLPWQPolynomial polynomial) {
		val literal = ISLPWQPolynomial._toString(polynomial, ISL_FORMAT.C.ordinal)
		val customExpr = Factory.customExpr(literal) 
