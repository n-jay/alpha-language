...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Fuzzy Arg Reduce Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link alpha.model.impl.ExternalFuzzyArgReduceExpressionImpl#getExternalFunction <em>External Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalFuzzyArgReduceExpressionImpl extends FuzzyArgReduceExpressionImpl implements ExternalFuzzyArgReduceExpression {
	/**
	 ...
	 * @generated
	 */
	protected ExternalFuzzyArgReduceExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.EXTERNAL_FUZZY_ARG_REDUCE_EXPRESSION;
	}
		...
		if (externalFunction != null && externalFunction.eIsProxy()) {
			...
			if (externalFunction != oldExternalFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.EXTERNAL_FUZZY_ARG_REDUCE_EXPRESSION__EXTERNAL_FUNCTION, oldExternalFunction, externalFunction));
			}
		}
	...
	public void setExternalFunction(ExternalFunction newExternalFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EXTERNAL_FUZZY_ARG_REDUCE_EXPRESSION__EXTERNAL_FUNCTION, oldExternalFunction, externalFunction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.EXTERNAL_FUZZY_ARG_REDUCE_EXPRESSION__EXTERNAL_FUNCTION:
...
} //ExternalFuzzyArgReduceExpressionImpl
