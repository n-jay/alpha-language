...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Fuzzy Reduce Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link alpha.model.impl.ExternalFuzzyReduceExpressionImpl#getExternalFunction <em>External Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalFuzzyReduceExpressionImpl extends FuzzyReduceExpressionImpl implements ExternalFuzzyReduceExpression {
	/**
	 ...
	 * @generated
	 */
	protected ExternalFuzzyReduceExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.EXTERNAL_FUZZY_REDUCE_EXPRESSION;
	}
		...
		if (externalFunction != null && externalFunction.eIsProxy()) {
			...
			if (externalFunction != oldExternalFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.EXTERNAL_FUZZY_REDUCE_EXPRESSION__EXTERNAL_FUNCTION, oldExternalFunction, externalFunction));
			}
		}
	...
	public void setExternalFunction(ExternalFunction newExternalFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EXTERNAL_FUZZY_REDUCE_EXPRESSION__EXTERNAL_FUNCTION, oldExternalFunction, externalFunction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.EXTERNAL_FUZZY_REDUCE_EXPRESSION__EXTERNAL_FUNCTION:
...
} //ExternalFuzzyReduceExpressionImpl
