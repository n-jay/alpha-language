 ...
 * </p>
 * <ul>
 *   <li>{@link alpha.model.impl.CalculatorExpressionImpl#getErrorMessage <em>Error Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CalculatorExpressionImpl extends MinimalEObjectImpl.Container implements CalculatorExpression {
	...
	public void setErrorMessage(String newErrorMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CALCULATOR_EXPRESSION__ERROR_MESSAGE, oldErrorMessage, errorMessage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.CALCULATOR_EXPRESSION__ERROR_MESSAGE:
