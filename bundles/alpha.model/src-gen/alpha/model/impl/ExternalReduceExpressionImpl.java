...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>External Reduce Expression</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link alpha.model.impl.ExternalReduceExpressionImpl#getExternalFunction <em>External Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ExternalReduceExpressionImpl extends ReduceExpressionImpl implements ExternalReduceExpression {
	/**
	 ...
	 * @generated
	 */
	protected ExternalReduceExpressionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.EXTERNAL_REDUCE_EXPRESSION;
	}
		...
		if (externalFunction != null && externalFunction.eIsProxy()) {
			...
			if (externalFunction != oldExternalFunction) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.EXTERNAL_REDUCE_EXPRESSION__EXTERNAL_FUNCTION, oldExternalFunction, externalFunction));
			}
		}
	...
	public void setExternalFunction(ExternalFunction newExternalFunction) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.EXTERNAL_REDUCE_EXPRESSION__EXTERNAL_FUNCTION, oldExternalFunction, externalFunction));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.EXTERNAL_REDUCE_EXPRESSION__EXTERNAL_FUNCTION:
