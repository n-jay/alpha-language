 ...
 * </p>
 * <ul>
 *   <li>{@link alpha.model.impl.VariableDomainImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableDomainImpl extends CalculatorExpressionImpl implements VariableDomain {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.VARIABLE_DOMAIN;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.VARIABLE_DOMAIN__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VARIABLE_DOMAIN__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.VARIABLE_DOMAIN__VARIABLE:
