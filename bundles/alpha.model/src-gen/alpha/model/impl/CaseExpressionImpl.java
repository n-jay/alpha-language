 ...
 * </p>
 * <ul>
 *   <li>{@link alpha.model.impl.CaseExpressionImpl#getName <em>Name</em>}</li>
 *   <li>{@link alpha.model.impl.CaseExpressionImpl#getExprs <em>Exprs</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CaseExpressionImpl extends AlphaExpressionImpl implements CaseExpression {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CASE_EXPRESSION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CASE_EXPRESSION__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ModelPackage.CASE_EXPRESSION__EXPRS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.CASE_EXPRESSION__NAME:
				return getName();
			case ModelPackage.CASE_EXPRESSION__EXPRS:
				return getExprs();
		}
