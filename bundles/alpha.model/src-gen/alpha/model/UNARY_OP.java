 ...
 * <!-- end-user-doc -->
 * @see alpha.model.ModelPackage#getUNARY_OP()
 * @model
 * @generated
 */
public enum UNARY_OP implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final UNARY_OP[] VALUES_ARRAY =
		new UNARY_OP[] {
			NOT,
			NEGATE,
		};
	 ...
	 * @generated
	 */
	public static final List<UNARY_OP> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	public static UNARY_OP get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UNARY_OP result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static UNARY_OP getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			UNARY_OP result = VALUES_ARRAY[i];
	 ...
	 * @generated
	 */
	public static UNARY_OP get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private UNARY_OP(int value, String name, String literal) {
		this.value = value;
		this.name = name;
