...
public interface AlphaFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>AIndex Dimension</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>AIndex Dimension</em>'.
   * @generated
   */
  AIndexDimension createAIndexDimension();
  ...
  /**
   * Returns a new object of class '<em>ADomain Expression</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ADomain Expression</em>'.
   * @generated
   */
  ADomainExpression createADomainExpression();

  /**
   * Returns a new object of class '<em>ADomain Terminal</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ADomain Terminal</em>'.
   * @generated
   */
  ADomainTerminal createADomainTerminal();

  /**
   * Returns a new object of class '<em>AISL Domain</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>AISL Domain</em>'.
   * @generated
   */
  AISLDomain createAISLDomain();
  ...
  /**
   * Returns a new object of class '<em>ADomain Product</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ADomain Product</em>'.
   * @generated
   */
  ADomainProduct createADomainProduct();
  ...
  /**
   * Returns a new object of class '<em>AParam Domain</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>AParam Domain</em>'.
   * @generated
   */
  AParamDomain createAParamDomain();

  /**
   * Returns a new object of class '<em>ARelation</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>ARelation</em>'.
   * @generated
   */
  ARelation createARelation();
