...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>AISL Domain</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link alpha.alpha.impl.AISLDomainImpl#getDims <em>Dims</em>}</li>
 *   <li>{@link alpha.alpha.impl.AISLDomainImpl#getConstraintString <em>Constraint String</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AISLDomainImpl extends ADomainTerminalImpl implements AISLDomain
{
  /**
  ...
  {
    return AlphaPackage.Literals.AISL_DOMAIN;
  }
  ...
  public NotificationChain basicSetDims(AIndexList newDims, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlphaPackage.AISL_DOMAIN__DIMS, oldDims, newDims);
  ...
  public void setDims(AIndexList newDims)
  {
    if (newDims != dims)
    {
      ...
      if (dims != null)
        msgs = ((InternalEObject)dims).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlphaPackage.AISL_DOMAIN__DIMS, null, msgs);
      if (newDims != null)
        msgs = ((InternalEObject)newDims).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlphaPackage.AISL_DOMAIN__DIMS, null, msgs);
      msgs = basicSetDims(newDims, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlphaPackage.AISL_DOMAIN__DIMS, newDims, newDims));
  }
  ...
  public void setConstraintString(String newConstraintString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlphaPackage.AISL_DOMAIN__CONSTRAINT_STRING, oldConstraintString, constraintString));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AlphaPackage.AISL_DOMAIN__DIMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AlphaPackage.AISL_DOMAIN__DIMS:
        return getDims();
      case AlphaPackage.AISL_DOMAIN__CONSTRAINT_STRING:
