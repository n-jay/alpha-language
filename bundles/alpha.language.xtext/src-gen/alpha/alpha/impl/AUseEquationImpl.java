...
public class AUseEquationImpl extends MinimalEObjectImpl.Container implements AUseEquation
{
   ...
   * @ordered
   */
  protected ADomain instantiationDomain;

  /**
   * The cached value of the '{@link #getSubsystemDims() <em>Subsystem Dims</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @ordered
   */
  protected AIndexList subsystemDims;
   ...
   * @ordered
   */
  protected AIndexList callParams;
   ...
   * @generated
   */
  public ADomain getInstantiationDomain()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetInstantiationDomain(ADomain newInstantiationDomain, NotificationChain msgs)
  {
    ADomain oldInstantiationDomain = instantiationDomain;
   ...
   * @generated
   */
  public void setInstantiationDomain(ADomain newInstantiationDomain)
  {
   ...
   * @generated
   */
  public AIndexList getSubsystemDims()
  {
   ...
   * @generated
   */
  public NotificationChain basicSetSubsystemDims(AIndexList newSubsystemDims, NotificationChain msgs)
  {
    AIndexList oldSubsystemDims = subsystemDims;
    subsystemDims = newSubsystemDims;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS, oldSubsystemDims, newSubsystemDims);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
   ...
   * @generated
   */
  public void setSubsystemDims(AIndexList newSubsystemDims)
  {
    if (newSubsystemDims != subsystemDims)
    {
      NotificationChain msgs = null;
      if (subsystemDims != null)
        msgs = ((InternalEObject)subsystemDims).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS, null, msgs);
      if (newSubsystemDims != null)
        msgs = ((InternalEObject)newSubsystemDims).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS, null, msgs);
      msgs = basicSetSubsystemDims(newSubsystemDims, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS, newSubsystemDims, newSubsystemDims));
  }
   ...
   * @generated
   */
  public AIndexList getCallParams()
  {
    return callParams;
  }
   ...
   * @generated
   */
  public NotificationChain basicSetCallParams(AIndexList newCallParams, NotificationChain msgs)
  {
    AIndexList oldCallParams = callParams;
   ...
   * @generated
   */
  public void setCallParams(AIndexList newCallParams)
  {
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS:
        return basicSetSubsystemDims(null, msgs);
  ...
  public void eSet(int featureID, Object newValue)
  {
    ...
    {
      case AlphaPackage.AUSE_EQUATION__INSTANTIATION_DOMAIN:
        setInstantiationDomain((ADomain)newValue);
        return;
      case AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS:
        setSubsystemDims((AIndexList)newValue);
        return;
      case AlphaPackage.AUSE_EQUATION__OUTPUT_EXPRS:
      ...
      case AlphaPackage.AUSE_EQUATION__SYSTEM:
        ...
        return;
      case AlphaPackage.AUSE_EQUATION__CALL_PARAMS:
        setCallParams((AIndexList)newValue);
        return;
      case AlphaPackage.AUSE_EQUATION__INPUT_EXPRS:
        getInputExprs().clear();
  ...
  public void eUnset(int featureID)
  {
    ...
    {
      case AlphaPackage.AUSE_EQUATION__INSTANTIATION_DOMAIN:
        setInstantiationDomain((ADomain)null);
        return;
      case AlphaPackage.AUSE_EQUATION__SUBSYSTEM_DIMS:
        setSubsystemDims((AIndexList)null);
        return;
      case AlphaPackage.AUSE_EQUATION__OUTPUT_EXPRS:
        getOutputExprs().clear();
        return;
