...
public class ADomainImpl extends MinimalEObjectImpl.Container implements ADomain
{
  ...
  {
    return AlphaPackage.Literals.ADOMAIN;
  }
  ...
  public NotificationChain basicSetDims(AIndexList newDims, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AlphaPackage.ADOMAIN__DIMS, oldDims, newDims);
  ...
  public void setDims(AIndexList newDims)
  {
    if (newDims != dims)
    {
      ...
      if (dims != null)
        msgs = ((InternalEObject)dims).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AlphaPackage.ADOMAIN__DIMS, null, msgs);
      if (newDims != null)
        msgs = ((InternalEObject)newDims).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AlphaPackage.ADOMAIN__DIMS, null, msgs);
      msgs = basicSetDims(newDims, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlphaPackage.ADOMAIN__DIMS, newDims, newDims));
  }
  ...
  public void setConstraintString(String newConstraintString)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AlphaPackage.ADOMAIN__CONSTRAINT_STRING, oldConstraintString, constraintString));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case AlphaPackage.ADOMAIN__DIMS:
