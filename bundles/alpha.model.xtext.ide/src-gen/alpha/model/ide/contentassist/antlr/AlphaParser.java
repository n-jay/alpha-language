		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getJNIFuzzyFunctionInArrayNotationAccess().getGroup(), "rule__JNIFuzzyFunctionInArrayNotation__Group__0");
					put(grammarAccess.getJNIFuzzyFunctionInArrayNotationAccess().getGroup_2(), "rule__JNIFuzzyFunctionInArrayNotation__Group_2__0");
					put(grammarAccess.getJNIFuzzyFunctionInArrayNotationAccess().getGroup_2_1(), "rule__JNIFuzzyFunctionInArrayNotation__Group_2_1__0");
					...
					put(grammarAccess.getAISLFuzzyRelationAccess().getGroup(), "rule__AISLFuzzyRelation__Group__0");
					put(grammarAccess.getAISLFuzzyRelationAccess().getGroup_2(), "rule__AISLFuzzyRelation__Group_2__0");
					put(grammarAccess.getAISLWrappedBasicRelationAccess().getGroup(), "rule__AISLWrappedBasicRelation__Group__0");
					put(grammarAccess.getAISLIndirectionAccess().getGroup(), "rule__AISLIndirection__Group__0");
					...
					put(grammarAccess.getJNIFuzzyFunctionAccess().getAlphaStringAssignment(), "rule__JNIFuzzyFunction__AlphaStringAssignment");
					put(grammarAccess.getJNIFuzzyFunctionInArrayNotationAccess().getArrayNotationAssignment_2_0(), "rule__JNIFuzzyFunctionInArrayNotation__ArrayNotationAssignment_2_0");
					put(grammarAccess.getJNIFuzzyFunctionInArrayNotationAccess().getArrayNotationAssignment_2_1_1(), "rule__JNIFuzzyFunctionInArrayNotation__ArrayNotationAssignment_2_1_1");
