		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getAlphaSystemAccess().getAlternatives_4_1(), "rule__AlphaSystem__Alternatives_4_1");
					put(grammarAccess.getAlphaSystemAccess().getAlternatives_5_1(), "rule__AlphaSystem__Alternatives_5_1");
					put(grammarAccess.getAlphaSystemAccess().getAlternatives_6_1(), "rule__AlphaSystem__Alternatives_6_1");
					put(grammarAccess.getFuzzyVariableUseAccess().getAlternatives(), "rule__FuzzyVariableUse__Alternatives");
					...
					put(grammarAccess.getAISLFuzzyExpressionAccess().getAlternatives(), "rule__AISLFuzzyExpression__Alternatives");
					...
					put(grammarAccess.getReductionsAccess().getAlternatives(), "rule__Reductions__Alternatives");
					...
					put(grammarAccess.getExternalArgReduceExpressionAccess().getProjectionExprAlternatives_4_0(), "rule__ExternalArgReduceExpression__ProjectionExprAlternatives_4_0");
					...
					put(grammarAccess.getFuzzyInputVariableAccess().getGroup(), "rule__FuzzyInputVariable__Group__0");
					put(grammarAccess.getFuzzyOutputVariableAccess().getGroup(), "rule__FuzzyOutputVariable__Group__0");
					put(grammarAccess.getFuzzyLocalVariableAccess().getGroup(), "rule__FuzzyLocalVariable__Group__0");
					...
					put(grammarAccess.getFuzzyFunctionAccess().getGroup(), "rule__FuzzyFunction__Group__0");
					put(grammarAccess.getFuzzyFunctionAccess().getGroup_2(), "rule__FuzzyFunction__Group_2__0");
					put(grammarAccess.getNestedFuzzyFunctionAccess().getGroup(), "rule__NestedFuzzyFunction__Group__0");
					put(grammarAccess.getNestedFuzzyFunctionAccess().getGroup_5(), "rule__NestedFuzzyFunction__Group_5__0");
					put(grammarAccess.getAffineFuzzyVariableUseAccess().getGroup(), "rule__AffineFuzzyVariableUse__Group__0");
					put(grammarAccess.getFuzzyFunctionInArrayNotationAccess().getGroup(), "rule__FuzzyFunctionInArrayNotation__Group__0");
					put(grammarAccess.getFuzzyFunctionInArrayNotationAccess().getGroup_2(), "rule__FuzzyFunctionInArrayNotation__Group_2__0");
					put(grammarAccess.getFuzzyFunctionInArrayNotationAccess().getGroup_2_1(), "rule__FuzzyFunctionInArrayNotation__Group_2_1__0");
					...
					put(grammarAccess.getAISLWrappedBasicRelationAccess().getGroup(), "rule__AISLWrappedBasicRelation__Group__0");
					...
					put(grammarAccess.getFuzzyReduceExpressionAccess().getGroup(), "rule__FuzzyReduceExpression__Group__0");
					put(grammarAccess.getExternalFuzzyReduceExpressionAccess().getGroup(), "rule__ExternalFuzzyReduceExpression__Group__0");
					put(grammarAccess.getFuzzyArgReduceExpressionAccess().getGroup(), "rule__FuzzyArgReduceExpression__Group__0");
					put(grammarAccess.getExternalFuzzyArgReduceExpressionAccess().getGroup(), "rule__ExternalFuzzyArgReduceExpression__Group__0");
					...
					put(grammarAccess.getAlphaSystemAccess().getParameterDomainExprAssignment_2(), "rule__AlphaSystem__ParameterDomainExprAssignment_2");
					put(grammarAccess.getAlphaSystemAccess().getDefinedObjectsAssignment_3_1(), "rule__AlphaSystem__DefinedObjectsAssignment_3_1");
					put(grammarAccess.getAlphaSystemAccess().getInputsAssignment_4_1_0(), "rule__AlphaSystem__InputsAssignment_4_1_0");
					put(grammarAccess.getAlphaSystemAccess().getInputsAssignment_4_1_1(), "rule__AlphaSystem__InputsAssignment_4_1_1");
					put(grammarAccess.getAlphaSystemAccess().getOutputsAssignment_5_1_0(), "rule__AlphaSystem__OutputsAssignment_5_1_0");
					put(grammarAccess.getAlphaSystemAccess().getOutputsAssignment_5_1_1(), "rule__AlphaSystem__OutputsAssignment_5_1_1");
					put(grammarAccess.getAlphaSystemAccess().getLocalsAssignment_6_1_0(), "rule__AlphaSystem__LocalsAssignment_6_1_0");
					put(grammarAccess.getAlphaSystemAccess().getLocalsAssignment_6_1_1(), "rule__AlphaSystem__LocalsAssignment_6_1_1");
					put(grammarAccess.getAlphaSystemAccess().getWhileDomainExprAssignment_7_1(), "rule__AlphaSystem__WhileDomainExprAssignment_7_1");
					put(grammarAccess.getAlphaSystemAccess().getTestExpressionAssignment_7_4(), "rule__AlphaSystem__TestExpressionAssignment_7_4");
					put(grammarAccess.getAlphaSystemAccess().getUseEquationsAssignment_8_1(), "rule__AlphaSystem__UseEquationsAssignment_8_1");
					put(grammarAccess.getAlphaSystemAccess().getEquationsAssignment_8_2(), "rule__AlphaSystem__EquationsAssignment_8_2");
					...
					put(grammarAccess.getFuzzyInputVariableAccess().getNameAssignment_1(), "rule__FuzzyInputVariable__NameAssignment_1");
					put(grammarAccess.getFuzzyInputVariableAccess().getDomainExprAssignment_3(), "rule__FuzzyInputVariable__DomainExprAssignment_3");
					put(grammarAccess.getFuzzyInputVariableAccess().getRangeExprAssignment_5(), "rule__FuzzyInputVariable__RangeExprAssignment_5");
					put(grammarAccess.getFuzzyOutputVariableAccess().getNameAssignment_1(), "rule__FuzzyOutputVariable__NameAssignment_1");
					put(grammarAccess.getFuzzyOutputVariableAccess().getDomainExprAssignment_3(), "rule__FuzzyOutputVariable__DomainExprAssignment_3");
					put(grammarAccess.getFuzzyOutputVariableAccess().getRangeExprAssignment_5(), "rule__FuzzyOutputVariable__RangeExprAssignment_5");
					put(grammarAccess.getFuzzyLocalVariableAccess().getNameAssignment_1(), "rule__FuzzyLocalVariable__NameAssignment_1");
					put(grammarAccess.getFuzzyLocalVariableAccess().getDomainExprAssignment_3(), "rule__FuzzyLocalVariable__DomainExprAssignment_3");
					put(grammarAccess.getFuzzyLocalVariableAccess().getRangeExprAssignment_5(), "rule__FuzzyLocalVariable__RangeExprAssignment_5");
					...
					put(grammarAccess.getFuzzyFunctionAccess().getAlphaStringAssignment_1(), "rule__FuzzyFunction__AlphaStringAssignment_1");
					put(grammarAccess.getFuzzyFunctionAccess().getIndirectionsAssignment_2_1(), "rule__FuzzyFunction__IndirectionsAssignment_2_1");
					put(grammarAccess.getNestedFuzzyFunctionAccess().getFuzzyIndexAssignment_0(), "rule__NestedFuzzyFunction__FuzzyIndexAssignment_0");
					put(grammarAccess.getNestedFuzzyFunctionAccess().getFuzzyVariableAssignment_2(), "rule__NestedFuzzyFunction__FuzzyVariableAssignment_2");
					put(grammarAccess.getNestedFuzzyFunctionAccess().getAlphaStringAssignment_4(), "rule__NestedFuzzyFunction__AlphaStringAssignment_4");
					put(grammarAccess.getNestedFuzzyFunctionAccess().getIndirectionsAssignment_5_1(), "rule__NestedFuzzyFunction__IndirectionsAssignment_5_1");
					put(grammarAccess.getAffineFuzzyVariableUseAccess().getFuzzyIndexAssignment_0(), "rule__AffineFuzzyVariableUse__FuzzyIndexAssignment_0");
					put(grammarAccess.getAffineFuzzyVariableUseAccess().getFuzzyVariableAssignment_2(), "rule__AffineFuzzyVariableUse__FuzzyVariableAssignment_2");
					put(grammarAccess.getAffineFuzzyVariableUseAccess().getUseFunctionAssignment_3(), "rule__AffineFuzzyVariableUse__UseFunctionAssignment_3");
					put(grammarAccess.getFuzzyFunctionInArrayNotationAccess().getArrayNotationAssignment_2_0(), "rule__FuzzyFunctionInArrayNotation__ArrayNotationAssignment_2_0");
					put(grammarAccess.getFuzzyFunctionInArrayNotationAccess().getArrayNotationAssignment_2_1_1(), "rule__FuzzyFunctionInArrayNotation__ArrayNotationAssignment_2_1_1");
					...
					put(grammarAccess.getUseEquationAccess().getCallParamsExprAssignment_6(), "rule__UseEquation__CallParamsExprAssignment_6");
					...
					put(grammarAccess.getDependenceExpressionAccess().getFunctionExprAssignment_0_0(), "rule__DependenceExpression__FunctionExprAssignment_0_0");
					...
					put(grammarAccess.getFuzzyDependenceExpressionAccess().getFuzzyFunctionAssignment_0_0(), "rule__FuzzyDependenceExpression__FuzzyFunctionAssignment_0_0");
					...
					put(grammarAccess.getFuzzyDependenceExpressionAccess().getFuzzyFunctionAssignment_1_1(), "rule__FuzzyDependenceExpression__FuzzyFunctionAssignment_1_1");
					...
					put(grammarAccess.getFuzzyIndexExpressionAccess().getFuzzyFunctionAssignment_0_1(), "rule__FuzzyIndexExpression__FuzzyFunctionAssignment_0_1");
					put(grammarAccess.getFuzzyIndexExpressionAccess().getFuzzyFunctionAssignment_1(), "rule__FuzzyIndexExpression__FuzzyFunctionAssignment_1");
					...
					put(grammarAccess.getExternalReduceExpressionAccess().getProjectionExprAssignment_4(), "rule__ExternalReduceExpression__ProjectionExprAssignment_4");
					...
					put(grammarAccess.getArgReduceExpressionAccess().getProjectionExprAssignment_4(), "rule__ArgReduceExpression__ProjectionExprAssignment_4");
					...
					put(grammarAccess.getExternalArgReduceExpressionAccess().getProjectionExprAssignment_4(), "rule__ExternalArgReduceExpression__ProjectionExprAssignment_4");
					...
					put(grammarAccess.getFuzzyReduceExpressionAccess().getOperatorAssignment_2(), "rule__FuzzyReduceExpression__OperatorAssignment_2");
					put(grammarAccess.getFuzzyReduceExpressionAccess().getProjectionFunctionAssignment_4(), "rule__FuzzyReduceExpression__ProjectionFunctionAssignment_4");
					put(grammarAccess.getFuzzyReduceExpressionAccess().getBodyAssignment_6(), "rule__FuzzyReduceExpression__BodyAssignment_6");
					put(grammarAccess.getExternalFuzzyReduceExpressionAccess().getExternalFunctionAssignment_2(), "rule__ExternalFuzzyReduceExpression__ExternalFunctionAssignment_2");
					put(grammarAccess.getExternalFuzzyReduceExpressionAccess().getProjectionFunctionAssignment_4(), "rule__ExternalFuzzyReduceExpression__ProjectionFunctionAssignment_4");
					put(grammarAccess.getExternalFuzzyReduceExpressionAccess().getBodyAssignment_6(), "rule__ExternalFuzzyReduceExpression__BodyAssignment_6");
					put(grammarAccess.getFuzzyArgReduceExpressionAccess().getOperatorAssignment_2(), "rule__FuzzyArgReduceExpression__OperatorAssignment_2");
					put(grammarAccess.getFuzzyArgReduceExpressionAccess().getProjectionFunctionAssignment_4(), "rule__FuzzyArgReduceExpression__ProjectionFunctionAssignment_4");
					put(grammarAccess.getFuzzyArgReduceExpressionAccess().getBodyAssignment_6(), "rule__FuzzyArgReduceExpression__BodyAssignment_6");
					put(grammarAccess.getExternalFuzzyArgReduceExpressionAccess().getExternalFunctionAssignment_2(), "rule__ExternalFuzzyArgReduceExpression__ExternalFunctionAssignment_2");
					put(grammarAccess.getExternalFuzzyArgReduceExpressionAccess().getProjectionFunctionAssignment_4(), "rule__ExternalFuzzyArgReduceExpression__ProjectionFunctionAssignment_4");
					put(grammarAccess.getExternalFuzzyArgReduceExpressionAccess().getBodyAssignment_6(), "rule__ExternalFuzzyArgReduceExpression__BodyAssignment_6");
					put(grammarAccess.getConvolutionExpressionAccess().getKernelDomainExprAssignment_2(), "rule__ConvolutionExpression__KernelDomainExprAssignment_2");
