...
public class AlphaParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, AlphaGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUseExpressionAccess().getAlternatives(), "rule__UseExpression__Alternatives");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getAlternatives(), "rule__SubSystemRestrictExpression__Alternatives");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getDomainExprAlternatives_0_0_0(), "rule__SubSystemRestrictExpression__DomainExprAlternatives_0_0_0");
			...
			builder.put(grammarAccess.getAlphaSystemAccess().getGroup_8(), "rule__AlphaSystem__Group_8__0");
			builder.put(grammarAccess.getInputVariableAccess().getGroup(), "rule__InputVariable__Group__0");
			...
			builder.put(grammarAccess.getFuzzyInputVariableAccess().getGroup(), "rule__FuzzyInputVariable__Group__0");
			builder.put(grammarAccess.getFuzzyOutputVariableAccess().getGroup(), "rule__FuzzyOutputVariable__Group__0");
			builder.put(grammarAccess.getFuzzyLocalVariableAccess().getGroup(), "rule__FuzzyLocalVariable__Group__0");
			...
			builder.put(grammarAccess.getAISLSetAccess().getGroup(), "rule__AISLSet__Group__0");
			builder.put(grammarAccess.getAISLSetAccess().getGroup_2(), "rule__AISLSet__Group_2__0");
			...
			builder.put(grammarAccess.getAAlphaFunctionAccess().getGroup(), "rule__AAlphaFunction__Group__0");
			...
			builder.put(grammarAccess.getUseEquationAccess().getGroup_0_2(), "rule__UseEquation__Group_0_2__0");
			builder.put(grammarAccess.getUseEquationAccess().getGroup_0_2_1(), "rule__UseEquation__Group_0_2_1__0");
			builder.put(grammarAccess.getUseEquationAccess().getGroup_0_2_1_2(), "rule__UseEquation__Group_0_2_1_2__0");
			builder.put(grammarAccess.getSubSystemCaseExpressionAccess().getGroup(), "rule__SubSystemCaseExpression__Group__0");
			builder.put(grammarAccess.getSubSystemCaseExpressionAccess().getGroup_2(), "rule__SubSystemCaseExpression__Group_2__0");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getGroup_0(), "rule__SubSystemRestrictExpression__Group_0__0");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getGroup_1(), "rule__SubSystemRestrictExpression__Group_1__0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getGroup(), "rule__SubSystemCallExpression__Group__0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getGroup_1(), "rule__SubSystemCallExpression__Group_1__0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getGroup_1_1(), "rule__SubSystemCallExpression__Group_1_1__0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getGroup_7(), "rule__SubSystemCallExpression__Group_7__0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getGroup_7_1(), "rule__SubSystemCallExpression__Group_7_1__0");
			...
			builder.put(grammarAccess.getAlphaSystemAccess().getInputsAssignment_4_1_1(), "rule__AlphaSystem__InputsAssignment_4_1_1");
			builder.put(grammarAccess.getAlphaSystemAccess().getOutputsAssignment_5_1_0(), "rule__AlphaSystem__OutputsAssignment_5_1_0");
			builder.put(grammarAccess.getAlphaSystemAccess().getOutputsAssignment_5_1_1(), "rule__AlphaSystem__OutputsAssignment_5_1_1");
			builder.put(grammarAccess.getAlphaSystemAccess().getLocalsAssignment_6_1_0(), "rule__AlphaSystem__LocalsAssignment_6_1_0");
			builder.put(grammarAccess.getAlphaSystemAccess().getLocalsAssignment_6_1_1(), "rule__AlphaSystem__LocalsAssignment_6_1_1");
			...
			builder.put(grammarAccess.getAlphaSystemAccess().getUseEquationsAssignment_8_1(), "rule__AlphaSystem__UseEquationsAssignment_8_1");
			builder.put(grammarAccess.getAlphaSystemAccess().getEquationsAssignment_8_2(), "rule__AlphaSystem__EquationsAssignment_8_2");
			...
			builder.put(grammarAccess.getOutputVariableAccess().getDomainExprAssignment_2(), "rule__OutputVariable__DomainExprAssignment_2");
			builder.put(grammarAccess.getLocalVariableAccess().getNameAssignment_0(), "rule__LocalVariable__NameAssignment_0");
			builder.put(grammarAccess.getLocalVariableAccess().getDomainExprAssignment_2(), "rule__LocalVariable__DomainExprAssignment_2");
			builder.put(grammarAccess.getFuzzyInputVariableAccess().getNameAssignment_1(), "rule__FuzzyInputVariable__NameAssignment_1");
			builder.put(grammarAccess.getFuzzyInputVariableAccess().getDomainExprAssignment_3(), "rule__FuzzyInputVariable__DomainExprAssignment_3");
			builder.put(grammarAccess.getFuzzyInputVariableAccess().getRangeExprAssignment_5(), "rule__FuzzyInputVariable__RangeExprAssignment_5");
			builder.put(grammarAccess.getFuzzyOutputVariableAccess().getNameAssignment_1(), "rule__FuzzyOutputVariable__NameAssignment_1");
			builder.put(grammarAccess.getFuzzyOutputVariableAccess().getDomainExprAssignment_3(), "rule__FuzzyOutputVariable__DomainExprAssignment_3");
			builder.put(grammarAccess.getFuzzyOutputVariableAccess().getRangeExprAssignment_5(), "rule__FuzzyOutputVariable__RangeExprAssignment_5");
			builder.put(grammarAccess.getFuzzyLocalVariableAccess().getNameAssignment_1(), "rule__FuzzyLocalVariable__NameAssignment_1");
			builder.put(grammarAccess.getFuzzyLocalVariableAccess().getDomainExprAssignment_3(), "rule__FuzzyLocalVariable__DomainExprAssignment_3");
			builder.put(grammarAccess.getFuzzyLocalVariableAccess().getRangeExprAssignment_5(), "rule__FuzzyLocalVariable__RangeExprAssignment_5");
			...
			builder.put(grammarAccess.getJNIFunctionAccess().getAlphaStringAssignment(), "rule__JNIFunction__AlphaStringAssignment");
			...
			builder.put(grammarAccess.getUseEquationAccess().getInstantiationDomainExprAssignment_0_1(), "rule__UseEquation__InstantiationDomainExprAssignment_0_1");
			builder.put(grammarAccess.getUseEquationAccess().getSubsystemDimsAssignment_0_2_1_1(), "rule__UseEquation__SubsystemDimsAssignment_0_2_1_1");
			builder.put(grammarAccess.getUseEquationAccess().getSubsystemDimsAssignment_0_2_1_2_1(), "rule__UseEquation__SubsystemDimsAssignment_0_2_1_2_1");
			builder.put(grammarAccess.getUseEquationAccess().getExprAssignment_1(), "rule__UseEquation__ExprAssignment_1");
			builder.put(grammarAccess.getSubSystemCaseExpressionAccess().getExprsAssignment_2_0(), "rule__SubSystemCaseExpression__ExprsAssignment_2_0");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getDomainExprAssignment_0_0(), "rule__SubSystemRestrictExpression__DomainExprAssignment_0_0");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getExprAssignment_0_2(), "rule__SubSystemRestrictExpression__ExprAssignment_0_2");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getDomainExprAssignment_1_1(), "rule__SubSystemRestrictExpression__DomainExprAssignment_1_1");
			builder.put(grammarAccess.getSubSystemRestrictExpressionAccess().getExprAssignment_1_4(), "rule__SubSystemRestrictExpression__ExprAssignment_1_4");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getOutputExprsAssignment_1_0(), "rule__SubSystemCallExpression__OutputExprsAssignment_1_0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getOutputExprsAssignment_1_1_1(), "rule__SubSystemCallExpression__OutputExprsAssignment_1_1_1");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getSystemAssignment_4(), "rule__SubSystemCallExpression__SystemAssignment_4");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getCallParamsExprAssignment_5(), "rule__SubSystemCallExpression__CallParamsExprAssignment_5");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getInputExprsAssignment_7_0(), "rule__SubSystemCallExpression__InputExprsAssignment_7_0");
			builder.put(grammarAccess.getSubSystemCallExpressionAccess().getInputExprsAssignment_7_1_1(), "rule__SubSystemCallExpression__InputExprsAssignment_7_1_1");
