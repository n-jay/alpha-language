 ...
 * </p>
 * <ul>
 *   <li>{@link alpha.targetmapping.impl.SetExpressionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SetExpressionImpl extends ScheduleTreeExpressionImpl implements SetExpression {
	/**
	...
	protected EClass eStaticClass() {
		return TargetmappingPackage.Literals.SET_EXPRESSION;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TargetmappingPackage.SET_EXPRESSION__CHILDREN:
