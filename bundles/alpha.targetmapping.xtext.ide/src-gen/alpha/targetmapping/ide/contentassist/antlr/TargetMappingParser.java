...
public class TargetMappingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TargetMappingGrammarAccess grammarAccess) {
			builder.put(grammarAccess.getTargetMappingAccess().getScheduleTreeAlternatives_2_0(), "rule__TargetMapping__ScheduleTreeAlternatives_2_0");
			...
			builder.put(grammarAccess.getBandExpressionAccess().getGroup_1_0(), "rule__BandExpression__Group_1_0__0");
			builder.put(grammarAccess.getBandExpressionAccess().getGroup_1_3(), "rule__BandExpression__Group_1_3__0");
			builder.put(grammarAccess.getBandExpressionAccess().getGroup_5(), "rule__BandExpression__Group_5__0");
			builder.put(grammarAccess.getBandPieceAccess().getGroup_0(), "rule__BandPiece__Group_0__0");
			...
			builder.put(grammarAccess.getLoopTypeSpecificationAccess().getGroup(), "rule__LoopTypeSpecification__Group__0");
			builder.put(grammarAccess.getBandPieceForReductionBodyAccess().getGroup(), "rule__BandPieceForReductionBody__Group__0");
			builder.put(grammarAccess.getBandPieceForReductionBodyAccess().getGroup_3(), "rule__BandPieceForReductionBody__Group_3__0");
			...
			builder.put(grammarAccess.getTargetMappingAccess().getScheduleTreeAssignment_2(), "rule__TargetMapping__ScheduleTreeAssignment_2");
			...
			builder.put(grammarAccess.getScheduleTargetRestrictDomainAccess().getRestrictDomainAssignment_2(), "rule__ScheduleTargetRestrictDomain__RestrictDomainAssignment_2");
			...
			builder.put(grammarAccess.getGuardExpressionAccess().getGuardDomainAssignment_1(), "rule__GuardExpression__GuardDomainAssignment_1");
			...
			builder.put(grammarAccess.getBandExpressionAccess().getTileAssignment_1_0_1(), "rule__BandExpression__TileAssignment_1_0_1");
			builder.put(grammarAccess.getBandExpressionAccess().getParallelAssignment_1_1(), "rule__BandExpression__ParallelAssignment_1_1");
			builder.put(grammarAccess.getBandExpressionAccess().getLoopTypeSpecificationsAssignment_1_2(), "rule__BandExpression__LoopTypeSpecificationsAssignment_1_2");
			builder.put(grammarAccess.getBandExpressionAccess().getIsolateSpecificationAssignment_1_3_0(), "rule__BandExpression__IsolateSpecificationAssignment_1_3_0");
			builder.put(grammarAccess.getBandExpressionAccess().getBandPiecesAssignment_3(), "rule__BandExpression__BandPiecesAssignment_3");
			builder.put(grammarAccess.getBandExpressionAccess().getChildAssignment_5_1(), "rule__BandExpression__ChildAssignment_5_1");
			builder.put(grammarAccess.getBandPieceAccess().getPieceDomainAssignment_0_0(), "rule__BandPiece__PieceDomainAssignment_0_0");
			builder.put(grammarAccess.getBandPieceAccess().getPartialScheduleAssignment_0_2(), "rule__BandPiece__PartialScheduleAssignment_0_2");
			builder.put(grammarAccess.getIsolateSpecificationAccess().getIsolateDomainAssignment_2(), "rule__IsolateSpecification__IsolateDomainAssignment_2");
			...
			builder.put(grammarAccess.getLoopTypeSpecificationAccess().getLoopTypeAssignment_0(), "rule__LoopTypeSpecification__LoopTypeAssignment_0");
			builder.put(grammarAccess.getLoopTypeSpecificationAccess().getDimensionAssignment_2(), "rule__LoopTypeSpecification__DimensionAssignment_2");
			builder.put(grammarAccess.getBandPieceForReductionBodyAccess().getPieceDomainAssignment_2(), "rule__BandPieceForReductionBody__PieceDomainAssignment_2");
			builder.put(grammarAccess.getBandPieceForReductionBodyAccess().getReductionInitializationAssignment_3_1(), "rule__BandPieceForReductionBody__ReductionInitializationAssignment_3_1");
			builder.put(grammarAccess.getBandPieceForReductionBodyAccess().getPartialScheduleAssignment_6(), "rule__BandPieceForReductionBody__PartialScheduleAssignment_6");
			...
			builder.put(grammarAccess.getBandExpressionAccess().getUnorderedGroup_1(), "rule__BandExpression__UnorderedGroup_1");
		}
	}
