...
public class TargetMappingParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TargetMappingGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTileBandExpressionAccess().getGroup(), "rule__TileBandExpression__Group__0");
			builder.put(grammarAccess.getTileBandExpressionAccess().getGroup_1(), "rule__TileBandExpression__Group_1__0");
			builder.put(grammarAccess.getTileBandExpressionAccess().getGroup_1_2(), "rule__TileBandExpression__Group_1_2__0");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getGroup(), "rule__FixedTilingTileLoopSpecification__Group__0");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getGroup_5(), "rule__FixedTilingTileLoopSpecification__Group_5__0");
			...
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getGroup_5(), "rule__ParametricTilingTileLoopSpecification__Group_5__0");
			...
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getGroup_5(), "rule__CompileTimeConstantTilingTileLoopSpecification__Group_5__0");
			...
			builder.put(grammarAccess.getTileBandExpressionAccess().getScheduleDimensionNamesAssignment_1_1(), "rule__TileBandExpression__ScheduleDimensionNamesAssignment_1_1");
			builder.put(grammarAccess.getTileBandExpressionAccess().getScheduleDimensionNamesAssignment_1_2_1(), "rule__TileBandExpression__ScheduleDimensionNamesAssignment_1_2_1");
			builder.put(grammarAccess.getTileBandExpressionAccess().getBandPiecesAssignment_3(), "rule__TileBandExpression__BandPiecesAssignment_3");
			builder.put(grammarAccess.getTileBandExpressionAccess().getTilingSpecificationAssignment_4(), "rule__TileBandExpression__TilingSpecificationAssignment_4");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getParallelAssignment_1(), "rule__FixedTilingTileLoopSpecification__ParallelAssignment_1");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getLoopScheduleExprAssignment_2(), "rule__FixedTilingTileLoopSpecification__LoopScheduleExprAssignment_2");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getTileSizeSpecificationsAssignment_4(), "rule__FixedTilingTileLoopSpecification__TileSizeSpecificationsAssignment_4");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getTileSizeSpecificationsAssignment_5_1(), "rule__FixedTilingTileLoopSpecification__TileSizeSpecificationsAssignment_5_1");
			builder.put(grammarAccess.getFixedTilingTileLoopSpecificationAccess().getTilingSpecificationAssignment_7(), "rule__FixedTilingTileLoopSpecification__TilingSpecificationAssignment_7");
			...
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getLoopScheduleExprAssignment_2(), "rule__ParametricTilingTileLoopSpecification__LoopScheduleExprAssignment_2");
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getTileSizeSpecificationsAssignment_4(), "rule__ParametricTilingTileLoopSpecification__TileSizeSpecificationsAssignment_4");
			builder.put(grammarAccess.getParametricTilingTileLoopSpecificationAccess().getTileSizeSpecificationsAssignment_5_1(), "rule__ParametricTilingTileLoopSpecification__TileSizeSpecificationsAssignment_5_1");
			...
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getLoopScheduleExprAssignment_2(), "rule__CompileTimeConstantTilingTileLoopSpecification__LoopScheduleExprAssignment_2");
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getTileSizeSpecificationsAssignment_4(), "rule__CompileTimeConstantTilingTileLoopSpecification__TileSizeSpecificationsAssignment_4");
			builder.put(grammarAccess.getCompileTimeConstantTilingTileLoopSpecificationAccess().getTileSizeSpecificationsAssignment_5_1(), "rule__CompileTimeConstantTilingTileLoopSpecification__TileSizeSpecificationsAssignment_5_1");
