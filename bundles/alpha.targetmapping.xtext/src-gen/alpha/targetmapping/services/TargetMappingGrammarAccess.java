...
@Singleton
public class TargetMappingGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class TargetMappingElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cScheduleTreeAssignment_2 = (Assignment)cGroup.eContents().get(2);
		private final Alternatives cScheduleTreeAlternatives_2_0 = (Alternatives)cScheduleTreeAssignment_2.eContents().get(0);
		private final RuleCall cScheduleTreeContextExpressionParserRuleCall_2_0_0 = (RuleCall)cScheduleTreeAlternatives_2_0.eContents().get(0);
		private final RuleCall cScheduleTreeScheduleTreeExpressionParserRuleCall_2_0_1 = (RuleCall)cScheduleTreeAlternatives_2_0.eContents().get(1);
		...
		//TargetMapping:
		//	'target' targetSystem=[model::AlphaSystem|QualifiedName] scheduleTree=(ContextExpression | ScheduleTreeExpression)?
		//	('MemoryMap' '{'
		...
		////	'}')?
		//scheduleTree=(ContextExpression | ScheduleTreeExpression)?
		public Assignment getScheduleTreeAssignment_2() { return cScheduleTreeAssignment_2; }
		
		//(ContextExpression | ScheduleTreeExpression)
		public Alternatives getScheduleTreeAlternatives_2_0() { return cScheduleTreeAlternatives_2_0; }
		
		//ContextExpression
		public RuleCall getScheduleTreeContextExpressionParserRuleCall_2_0_0() { return cScheduleTreeContextExpressionParserRuleCall_2_0_0; }
		
		//ScheduleTreeExpression
		public RuleCall getScheduleTreeScheduleTreeExpressionParserRuleCall_2_0_1() { return cScheduleTreeScheduleTreeExpressionParserRuleCall_2_0_1; }
