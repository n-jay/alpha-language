...
public class InternalTargetMappingLexer extends Lexer {
    ...
    public final void mRULE_BOOLEAN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10324:14: ( ( 'true' | 'false' ) )
            // InternalTargetMapping.g:10324:16: ( 'true' | 'false' )
            {
            // InternalTargetMapping.g:10324:16: ( 'true' | 'false' )
            int alt1=2;
            ...
            switch (alt1) {
                case 1 :
                    // InternalTargetMapping.g:10324:17: 'true'
                    {
                    match("true"); 
                    ...
                    break;
                case 2 :
                    // InternalTargetMapping.g:10324:24: 'false'
                    {
                    match("false"); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10326:9: ( ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\'' ) )
            // InternalTargetMapping.g:10326:11: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\'' )
            {
            // InternalTargetMapping.g:10326:11: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* | '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\'' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalTargetMapping.g:10326:12: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
                    {
                    // InternalTargetMapping.g:10326:12: ( '^' )?
                    int alt2=2;
                    ...
                    // InternalTargetMapping.g:10326:41: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
                    ...
                    break;
                case 2 :
                    // InternalTargetMapping.g:10326:75: '\\'' ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+ '\\''
                    {
                    match('\''); 
                    // InternalTargetMapping.g:10326:80: ( 'a' .. 'z' | 'A' .. 'Z' | '~' | '!' | '@' | '#' | '$' | '%' | '^' | '&' | '*' | '(' | ')' | '-' | '_' | '+' | '=' | '|' | '/' | '?' | '0' .. '9' )+
                    int cnt4=0;
                    loop4:
                    do {
                        int alt4=2;
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10328:13: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalTargetMapping.g:10328:15: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalTargetMapping.g:10328:19: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
            loop6:
            do {
                int alt6=3;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalTargetMapping.g:10328:20: '\\\\' .
            	    {
            	    match('\\'); 
            	    matchAny(); 
            	    ...
            	    break;
            	case 2 :
            	    // InternalTargetMapping.g:10328:27: ~ ( ( '\\\\' | '\"' ) )
            	    {
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10330:10: ( ( '0' .. '9' )+ )
            // InternalTargetMapping.g:10330:12: ( '0' .. '9' )+
            {
            // InternalTargetMapping.g:10330:12: ( '0' .. '9' )+
            int cnt7=0;
            loop7:
            do {
                ...
                switch (alt7) {
            	case 1 :
            	    // InternalTargetMapping.g:10330:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10332:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalTargetMapping.g:10332:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalTargetMapping.g:10332:24: ( options {greedy=false; } : . )*
            loop8:
            do {
                int alt8=2;
                ...
                switch (alt8) {
            	case 1 :
            	    // InternalTargetMapping.g:10332:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10334:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // InternalTargetMapping.g:10334:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // InternalTargetMapping.g:10334:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop9:
            do {
                int alt9=2;
            ...
            // InternalTargetMapping.g:10334:40: ( ( '\\r' )? '\\n' )?
            int alt11=2;
            ...
            switch (alt11) {
                case 1 :
                    // InternalTargetMapping.g:10334:41: ( '\\r' )? '\\n'
                    {
                    // InternalTargetMapping.g:10334:41: ( '\\r' )?
                    int alt10=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10336:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // InternalTargetMapping.g:10336:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // InternalTargetMapping.g:10336:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt12=0;
            loop12:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTargetMapping.g:10338:16: ( . )
            // InternalTargetMapping.g:10338:18: .
            {
            matchAny(); 
